...
if(((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$))) && (cljs.core.every_QMARK_((function (p1__13081_SHARP_){
return ((p1__13081_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__13081_SHARP_ === 'string');
}),class$))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__13083,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$class], null),sablono.normalize.class$);
} else {
return G__13083;
}
});
...
var len__7982__auto___13086 = arguments.length;
var i__7983__auto___13087 = (0);
while(true){
if((i__7983__auto___13087 < len__7982__auto___13086)){
args__7989__auto__.push((arguments[i__7983__auto___13087]));

var G__13088 = (i__7983__auto___13087 + (1));
i__7983__auto___13087 = G__13088;
continue;
} else {
}
break;
...
var G__13085 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_(classes__$1))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13085,cljs.core.cst$kw$class,classes__$1);
} else {
return G__13085;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq13084){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq13084));
});
...
var vec__13094 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2([cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$tag,s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst(matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(matches),cljs.core.rest(matches)], null)
));
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13094,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13094,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.normalize.strip_css,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (matches,vec__13094,tag_name,names){
return (function (p1__13089_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__13089_SHARP_));
});})(matches,vec__13094,tag_name,names))
,names))),cljs.core.vec(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.normalize.strip_css,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (matches,vec__13094,tag_name,names){
return (function (p1__13090_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__13090_SHARP_));
});})(matches,vec__13094,tag_name,names))
,names)))], null);
});
/**
...
return cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,((typeof x === 'string')?(function (){var x__7711__auto__ = x;
...
return cljs.core._conj(cljs.core.List.EMPTY,x__7711__auto__);
})():(((cljs.core.list_QMARK_(x)) && ((x instanceof cljs.core.Symbol)))?(function (){var x__7711__auto__ = x;
return cljs.core._conj(cljs.core.List.EMPTY,x__7711__auto__);
})():((cljs.core.list_QMARK_(x))?x:(((cljs.core.sequential_QMARK_(x)) && (cljs.core.sequential_QMARK_(cljs.core.first(x))) && (!(typeof cljs.core.first(x) === 'string')) && (cljs.core.not(sablono.util.element_QMARK_(cljs.core.first(x)))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.count(x),(1))))?(function (){var G__13098 = cljs.core.first(x);
return (sablono.normalize.children.cljs$core$IFn$_invoke$arity$1 ? sablono.normalize.children.cljs$core$IFn$_invoke$arity$1(G__13098) : sablono.normalize.children.call(null,G__13098));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__13099){
var vec__13106 = p__13099;
var seq__13107 = cljs.core.seq(vec__13106);
var first__13108 = cljs.core.first(seq__13107);
var seq__13107__$1 = cljs.core.next(seq__13107);
var tag = first__13108;
var content = seq__13107__$1;
...
var vec__13109 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13109,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13109,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13109,(2),null);
